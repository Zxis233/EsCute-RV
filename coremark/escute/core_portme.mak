...
PORT_CFLAGS = -O2 -g
ARCH_FLAGS  = -march=rv32i_zicsr_zmmul -mabi=ilp32
...
LOAD = elf2hex 4 8192 $(OUTFILE) > $(PORT_DIR)/coremark.hex && riscv64-unknown-elf-objdump -d $(PORT_DIR)/coremark.hex > $(PORT_DIR)/coremark.SText
